    ...
    handleSimpan = () => {
        if (this.state.insertProduk.total_qty <= 0) {
            ...
            fetch("http://localhost:3002/cart", {
                ...
                if (response.ok) {
                    alert("Pembelian Berhasil di masukkan ke Cart")
                    this.setState({
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td rowSpan="2">Jumlah :
                                ...
                                <br />
                                Total : Rp. {this.state.insertProduk.total_harga}
                                <br />
                                <button type="submit" style={{ display: "block", marginTop: 15 }} onClick={this.handleSimpan} className="button_cart">Beli</button>
                            </td>
                        </tr>
                        <tr>
